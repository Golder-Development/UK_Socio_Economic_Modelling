"""
Script to fetch Residence Type by Age data from the ONS API.

This dataset provides Census 2021 information about the types of residences 
(e.g., houses, flats) broken down by age groups of the residents.
...
DATASET_ID = "RM119"  # Residence Type by Age dataset ID
...
def main():
    """Main entry point."""
    logger.info(f"Fetching Residence Type by Age data (Census 2021)")
    ...
    output_file = extract_dir / "residence_type_by_age_data.csv"
