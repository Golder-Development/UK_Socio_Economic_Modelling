"""
Script to fetch Population Density data from the ONS API.

Population density measures the number of people per square kilometer
across different geographic areas in the UK. This is Census 2021 data.
...
DATASET_ID = "TS006"  # Population density dataset ID
...
def main():
    """Main entry point."""
    logger.info(f"Fetching Population Density data (Census 2021)")
    ...
    try:
        ...
        logger.info(f"Description: {dataset.get('description', 'N/A')}")
    ...
    output_file = extract_dir / "population_density_data.csv"
