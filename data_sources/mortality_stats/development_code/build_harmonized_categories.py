...
HARMONIZED_CATEGORIES = {
    'infectious_diseases': {
        ...
        'keywords': ['fever', 'pox', 'plague', 'cholera', 'typhus', 'typhoid', 'malaria', 
                     'diphtheria', 'whooping', 'scarlet', 'measles', 'influenza', 'tuberculosis',
                     'septic', 'infection', 'tetanus', 'anthrax', 'rabies', 'syphilis', 'gonorrhoea',
                     'dysentery', 'enteritis', 'diarrhoea', 'polio', 'encephalitis', 'meningitis',
                     'leprosy', 'mumps', 'rubella', 'pertussis', 'streptococcal', 'staphylococcal',
                     'pneumococcal', 'viral', 'bacterial', 'parasit', 'helminth', 'fungal']
    },
    'neoplasms': {
        'name': 'Neoplasms (Cancers and Tumors)',
        'keywords': ['cancer', 'carcinoma', 'sarcoma', 'tumor', 'tumour', 'neoplasm', 
                     'malignant', 'benign', 'lymphoma', 'leukaemia', 'leukemia', 'melanoma',
                     'adenoma', 'adenocarcinoma', 'glioma', 'metasta']
    },
    'blood_immune': {
        'name': 'Blood and Immune System Disorders',
        'keywords': ['anaemia', 'anemia', 'haemophilia', 'purpura', 'thrombocytopeni',
                     'agranulocytosis', 'immunodeficiency', 'immune disorder']
    },
    'endocrine_metabolic': {
        'name': 'Endocrine, Nutritional and Metabolic Diseases',
        'keywords': ['diabetes', 'thyroid', 'goitre', 'gout', 'rickets', 'scurvy', 'beriberi',
                     'pellagra', 'marasmus', 'kwashiorkor', 'malnutrition', 'obesity', 'vitamin deficiency',
                     'metabolic', 'addison', 'cushing', 'acromegaly']
    },
    'mental_behavioral': {
        'name': 'Mental and Behavioral Disorders',
        'keywords': ['mental', 'insanity', 'mania', 'melancholia', 'psychosis', 'neurosis',
                     'dementia', 'delirium', 'alcoholism', 'drug dependence', 'schizophrenia',
                     'depression', 'anxiety', 'intellectual disability']
    },
    'nervous_system': {
        'name': 'Diseases of the Nervous System',
        'keywords': ['nervous', 'brain', 'cerebral', 'apoplexy', 'paralysis', 'hemiplegia',
                     'epilepsy', 'convulsion', 'meningitis', 'encephalitis', 'parkinson',
                     'multiple sclerosis', 'neuralgia', 'neuritis', 'migraine', 'headache']
    },
    'eye_ear': {
        'name': 'Diseases of Eye and Ear',
        'keywords': ['eye', 'vision', 'blind', 'cataract', 'glaucoma', 'ear', 'deaf', 'otitis']
    },
    'circulatory': {
        'name': 'Diseases of the Circulatory System',
        'keywords': ['heart', 'cardiac', 'myocardi', 'endocardi', 'pericardi', 'angina',
                     'coronary', 'artery', 'arteriosclerosis', 'atherosclerosis', 'hypertension',
                     'stroke', 'cerebrovascular', 'haemorrhage', 'hemorrhage', 'embolism', 
                     'thrombosis', 'aneurysm', 'varicose', 'phlebitis', 'gangrene', 'vascular']
    },
    'respiratory': {
        'name': 'Diseases of the Respiratory System',
        'keywords': ['lung', 'pulmonary', 'bronch', 'pneumonia', 'asthma', 'emphysema',
                     'larynx', 'laryngitis', 'croup', 'pharynx', 'tonsil', 'respiratory',
                     'pleurisy', 'pleural', 'pneumothorax', 'silicosis', 'asbestosis']
    },
    'digestive': {
        'name': 'Diseases of the Digestive System',
        'keywords': ['stomach', 'gastric', 'gastritis', 'ulcer', 'intestin', 'bowel', 'colon',
                     'rectum', 'anus', 'appendicitis', 'peritonitis', 'hernia', 'liver', 'hepat',
                     'cirrhosis', 'gallbladder', 'cholecyst', 'pancrea', 'oesophag', 'esophag',
                     'digestive', 'alimentary']
    },
    'skin': {
        'name': 'Diseases of the Skin',
        'keywords': ['skin', 'dermat', 'eczema', 'psoriasis', 'ulcer', 'abscess', 'carbuncle',
                     'cellulitis', 'gangrene']
    },
    'musculoskeletal': {
        'name': 'Diseases of Musculoskeletal System and Connective Tissue',
        'keywords': ['arthritis', 'rheumat', 'osteo', 'bone', 'joint', 'muscle', 'muscular',
                     'spine', 'spinal', 'scoliosis', 'dorsopathy']
    },
    'genitourinary': {
        'name': 'Diseases of the Genitourinary System',
        'keywords': ['kidney', 'renal', 'nephri', 'urinary', 'bladder', 'cystitis', 'urethr',
                     'prostate', 'uterus', 'ovary', 'vagina', 'menstrual', 'genital']
    },
    'pregnancy_childbirth': {
        'name': 'Pregnancy, Childbirth and Puerperium',
        'keywords': ['pregnancy', 'pregnant', 'childbirth', 'labour', 'labor', 'delivery',
                     'puerperal', 'placenta', 'abortion', 'miscarriage', 'ectopic', 'obstetric']
    },
    'perinatal': {
        'name': 'Conditions Originating in Perinatal Period',
        'keywords': ['newborn', 'neonatal', 'birth', 'prematurity', 'foetal', 'fetal',
                     'perinatal', 'congenital']
    },
    'congenital': {
        'name': 'Congenital Malformations and Chromosomal Abnormalities',
        'keywords': ['congenital', 'malformation', 'deformity', 'chromosomal', 'down syndrome',
                     'spina bifida', 'cleft']
    },
    'injury_poisoning': {
        'name': 'Injury, Poisoning and External Causes',
        'keywords': ['injury', 'trauma', 'wound', 'fracture', 'burn', 'poison', 'toxic',
                     'accident', 'suicide', 'homicide', 'violence', 'assault', 'drown',
                     'suffocation', 'fall', 'crush', 'motor vehicle', 'railway', 'fire']
    },
    'ill_defined': {
        'name': 'Symptoms, Signs and Ill-Defined Conditions',
        'keywords': ['symptom', 'sign', 'ill-defined', 'unknown', 'unspecified', 'senility',
                     'old age', 'debility', 'sudden death', 'found dead']
    },
    'other': {
...
def build_harmonized_mapping():
    ...
    if not desc_file.exists():
        logger.error("icd_code_descriptions.csv not found. Run build_code_descriptions.py first.")
        return None
    ...
    for _, row in descriptions_df.iterrows():
        cat_id, cat_name, confidence = classify_by_keywords(row['description'], row['code'])
        results.append({
            'code': row['code'],
    ...
    for cat_id, cat_info in list(HARMONIZED_CATEGORIES.items())[:5]:
        ...
        for _, ex in examples.iterrows():
            logger.info(f"  {ex['icd_version']:20s} Code {ex['code']:10s}: {ex['original_description']}")
...
def main():
    ...
    if harmonized_df is not None:
        ...
        logger.info('=' * 80)
        logger.info("\nNext steps:")
        logger.info("1. Review the harmonized categories in 'icd_harmonized_categories.csv'")
        logger.info("2. Adjust keyword matching if needed")
        logger.info("3. Run 'add_harmonized_categories_to_mortality.py' to add to mortality data")
