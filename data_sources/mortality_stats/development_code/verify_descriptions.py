...
print('=' * 80)
sample = df[df['year'].between(1901, 1910)][['year', 'cause', 'cause_description', 'deaths']].drop_duplicates(subset=['cause']).head(20)
...
code_10_desc = desc_df[desc_df['code'] == '10.0'][['code', 'description', 'icd_version']]
