...
def prepare_ministers_data(df):
    ...
    def is_senior_cabinet(post):
        ...
        senior_keywords = ['secretary of state',
                            'chancellor',
                            'lord chancellor',
                            'chief secretary',
                            'lord president',
...
def main():
    ...
    if len(pre_2015_6m) > 0 and len(post_2015_6m) > 0:
        ...
        if rate_change < 0 or pct_change < 0:
            print("  ✓ SUPPORTS PENSION THEORY - Fewer pension abusers after reform")
        else:
            print("  ✗ CONTRADICTS PENSION THEORY - More pension abusers after reform")
