"""
Restore individual_cabinet_analysis.html to original format without pension analysis
Focus only on career pattern scatter plot and categories
"""
...
<body>
    <div class="header">
        ...
        <p>Analysis of 311 Senior Cabinet Members (1959-2024)</p>
    ...
    <div class="key-insights">
        <h2>🔑 Key Insights</h2>
        <ul>
            <li><strong>311 unique individuals</strong> served in senior Cabinet roles between 1959-2024</li>
            <li><strong>Stalwarts</strong> ({category_counts.get('Stalwart', 0)} members) had multiple spells and long tenure, representing experienced leadership</li>
            <li><strong>Sacrificial Pawns</strong> ({category_counts.get('Sacrificial Pawn', 0)} members) had frequent but brief appointments, often during crises</li>
            <li><strong>Long-Tenure Specialists</strong> ({category_counts.get('Long-Tenure Specialist', 0)} members) held single positions for extended periods</li>
            <li><strong>Rising Stars</strong> ({category_counts.get('Rising Star', 0)} members) showed progression with longer tenures across appointments</li>
            <li><strong>Portfolio Rotators</strong> ({category_counts.get('Portfolio Rotator', 0)} members) moved between multiple positions with moderate tenure</li>
        </ul>
    </div>
    ...
    <div class="section">
        ...
        <div class="stat-grid">
            <div class="stat-box">
                ...
                <div class="stat-value">{len(person_stats)}</div>
            </div>
            <div class="stat-box">
                <div class="stat-label">Average Spells</div>
                <div class="stat-value">{person_stats['spell_count'].mean():.1f}</div>
            </div>
            <div class="stat-box">
                <div class="stat-label">Average Total Years</div>
                <div class="stat-value">{person_stats['total_years'].mean():.1f}</div>
            </div>
            <div class="stat-box">
                <div class="stat-label">Longest Career</div>
                <div class="stat-value">{person_stats['total_years'].max():.1f}yr</div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <h2>Career Pattern Categories Explained</h2>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li><strong>Senior Posts:</strong> Secretary of State, Chancellor of the Exchequer, Lord Chancellor, Chief Secretary to the Treasury, 
                Lord President of the Council, Minister without Portfolio</li>
            <li><strong>Exclusions:</strong> Prime Ministers (analyzed separately), House of Lords-only appointments</li>
            <li><strong>Dataset:</strong> 578 senior cabinet appointments across 311 unique individuals</li>
...
print(f"✓ Categories: {len(categories)} career patterns")
print("✓ Format: Original career pattern focus, no pension content")
